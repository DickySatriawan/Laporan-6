 ...
 * @author DS
 */
public class PegawaiT extends Pegawai {
    ...
    public PegawaiT(String nama, String idKerja, boolean punyaIstri, int jumlahAnak, long tahunKerja, float gaji) {
        super(nama, idKerja, "Pegawai Tetap", punyaIstri, jumlahAnak, tahunKerja, gaji);
        this.calculateBonus();
    ...
    public String toString() {
        return String.format("Nama \t\t\t: %s\nID Kerja \t\t: %s\nJabatan \t\t: %s\nPunya Istri \t\t: %s\n"
                ...
                + "%.2f\nTotal Gaji \t\t: %.2f", super.getNama(), super.getIdKerja(), super.getJabatan(),
                super.isPunyaIstri() ? "Punya" : "Tidak punya", super.getJumlahAnak(),
                super.getTahunKerja(), super.getGaji(), bonus, tunjanganLamaKerja,
                tunjanganIstri, tunjanganAnak, getTotalGaji());
    }
}
